...
<style>
yt-live-chat-text-message-renderer>#content>#joinGroupMessage>.el-badge {
  margin-left: 10px;
}

yt-live-chat-text-message-renderer>#content>#joinGroupMessage>.el-badge .el-badge__content {
